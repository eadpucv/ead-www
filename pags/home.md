...
<!-- NOTICIAS -->      
     <div class='col-md-12 col-md-offset-0 col-sm-14 col-sm-offset-1 col-xs-22 col-xs-offset-1 margen-superior'>
        <h2 class='gris'>NOTICIAS</h2><hr>
...
<!--  noticia 1 -->
      <div class='fila'>
        ...
        <div class='col-lg-1 estampilla derecha menu-rapido-ead fondo-gris'>
          <h4 class='blanco centrado'>1</h4>
        </div>
        </div>
...
<!-- noticia 3 -->   
      <div class='fila'>
        <div class='col-md-24 col-md-24 col-sm-20 caja-noticia-ead fondo-gris-blanco'>
          ...
          <div class='col-lg-1 estampilla derecha menu-rapido-ead fondo-gris'>
            <h4 class='blanco centrado'>3</h4>
          </div>
        </div>
      </div>       
    </div> <!-- fin de noticias 3 -->
<!-- FIN DE NOTICIAS -->
...
<!-- ASIDE XS  -->
    ...
    <div class='fila'> <!-- info de docencia -->
...
<!-- ASIDE LG -->
       <div class='col-lg-5 col-md-5 col-md-offset-0 oculto-sm oculto-xs margen-superior margen-izquierdo'>
          <h2 class='gris'>ENLACES</h2><hr>
